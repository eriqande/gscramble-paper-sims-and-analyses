...
Letus  quickly plot these to see what it is looking like:
```{r}
tib2 %>%
...
```{r}
ggsave(g, filename = snakemake@output$fig, width = 8, height = 5.5)
```
